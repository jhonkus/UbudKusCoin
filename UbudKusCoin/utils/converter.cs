    ...
    public static class Converter
    {
        ...
        */
        ...
        public static byte[] ConvertToByte(this Transaction[] lsTrx)
        {
            ...
            for (int i = 0; i < lsTrx.Length; i++)
            {
                sbf.Append(lsTrx[i].ConvertToString());
            }
            return sbf.ToString().ConvertToBytes();
        }
        ...
        */
        ...
        public static string ConvertToDateTime(this Int64 timestamp) {
            ...
            String strDate = myDate.ToString("dd MMM yyyy hh:mm:ss");
        ...
        public static string ConvertToString(this Transaction trx)
        {
            string str = $"\n            Sender:{trx.Sender}, Recipient:{trx.Recipient}, Amount:{trx.Amount}, Fee:{trx.Fee}";
            return str;
        }
